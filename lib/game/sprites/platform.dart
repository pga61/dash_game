...
// More on Platforms: Add Spring State Enum
...
class EnemyPlatform extends Platform<EnemyPlatformState> {
  ...
  Future<void>? onLoad() async {
    ...
    var currentIndexEnemy = _rand.nextInt(4); // generate a number 0-3 inclusive
    final enemySprite = _enemies[currentIndexEnemy];
    // debugPrint('$currentIndexEnemy - $enemySprite');
