...
class GameOverlayState extends State<GameOverlay> {
  ...
  // TODOOK: Mobile Support: Add isMobile boolean
    ...
    return Material(
      ...
      child: Stack(
        children: [
          ...
          // display left and right directional buttons in the overlay when the game runs on mobile
          if (isMobile)
            Positioned(
          ...
          // TODOOK: Mobile Support: Add on-screen left & right directional buttons
          if (isPaused)
            Positioned(
